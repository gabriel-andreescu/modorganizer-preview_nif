...
public:
  ...
  bool isAlphaBlendEnabled() { return m_AlphaBlendEnable; }

  GLenum sourceBlendingFactor() { return getBlendMode(m_SrcBlendMode); }

  GLenum destinationBlendingFactor() { return getBlendMode(m_DstBlendMode); }

  bool isAlphaTestEnabled() { return m_AlphaTestEnable; }

  GLenum alphaTestMode() { return getTestMode(m_AlphaTestMode); }

  bool isTriangleSortDisabled() { return m_NoSort; }
...
inline nifly::MatTransform GetShapeTransformToGlobal(nifly::NifFile* nifFile,
